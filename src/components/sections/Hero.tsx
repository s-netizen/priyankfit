    ...
    <section ref={heroRef} className="relative min-h-screen overflow-hidden" style={{ background: "#0A0A0A" }}>
      ...
      <div className="md:hidden absolute inset-0">
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(180deg, rgba(10,10,10,0.55) 0%, rgba(10,10,10,0.4) 30%, rgba(10,10,10,0.75) 65%, rgba(10,10,10,0.98) 100%)",
          }}
        />
        {/* Red tint at top */}
        <div
          ...
          <div className="max-w-7xl mx-auto px-6 pt-24 pb-8 w-full">
            <div className="max-w-xl">
              ...
              <p
                ...
                style={{ fontSize: "clamp(0.88rem, 2.2vw, 1rem)", lineHeight: 1.75, maxWidth: 440 }}
              >
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  {[
                    ...
                    <img key={i} src={src} alt="" className="w-8 h-8 rounded-full object-cover border-2" style={{ borderColor: "#0A0A0A" }} />
                  ))}
                </div>
                <div>
